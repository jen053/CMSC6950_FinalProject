...
measurements that resulted in each respective direction. Finally, the color scheme of the bars represents the range wind speeds observed in each direction. 
