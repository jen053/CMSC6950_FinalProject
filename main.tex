...
apply it to some wind data collected at airports around the province of Newfoundland and Labrador. We also so a way of connecting these polar diagrams to a mapping package (mpl_toolkits.basemap), which inturns 
