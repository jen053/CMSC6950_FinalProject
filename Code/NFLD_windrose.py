...
def plot(filename, location, cmap, bin_interval=10, plt_type='bar', saveImage=False):
    """
...
plot('C:/Users/Jacob/CMSC6950_py/Open_Science_Project/CMSC6950_FinalProject/Data/Gander_1980-2012.csv',
     location="Gander Airport",
     bin_interval=10,
     plt_type='contourf', cmap=cm.hot, saveImage=True)
