...
def plotboxWindrose(filename, location, cmap=cm.hot, bin_interval=10):
    """
    ...
    plt.savefig('C:/Users/Jacob/CMSC6950_py/Open_Science_Project/CMSC6950_FinalProject/box.pdf')
...
def main(args):
    ...
    plotboxWindrose(filename=args[1], location=args[2])
